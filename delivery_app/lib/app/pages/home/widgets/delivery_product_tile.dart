  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async {
        ...
        final orderProductReceived = await Navigator.of(context).pushNamed(
          '/productDetail',
          arguments: {
            'product': product,
            'order': orderProduct,
        ...
        if (orderProductReceived != null) {
          controller.addOrUpdateBag(orderProductReceived as OrderProductDto);
        }
      },
      child: Padding(
